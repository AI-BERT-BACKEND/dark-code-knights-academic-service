...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request body for updating an existing grade activity")
public class UpdateGradeRequestDTO {
    ...
    @Schema(example = "5.0", description = "Updated grade value on the Colombian 0.0–5.0 scale")
    ...
    @Schema(example = "60.0", description = "Updated weight of this activity within the evaluation cut (0.1–100.0)")
